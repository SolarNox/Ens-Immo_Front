...
class AutreProbleme extends React.Component {
    constructor() {
        super();
        this.state = {
            choicePicker: "Nuisance sonore",
            autreProbleme: "",
            descriptionProblem: "",
            privateOrNot: true
        }
    ...
    sendLogs = () => {
        ...
        fetch(`${ipAdress}/users/coproSendLog`, {
            ...
            body: `tokenUser=${this.props.user.token}&tokenCopro=${this.props.copro._id}&type=Autres&titleType=${this.state.choicePicker}&privateOrNot=${this.state.privateOrNot}&title=${this.state.autreProbleme}&description=${this.state.descriptionProblem}`
        })
    ...
    render() {
        ...
        <View style={{ flex: 1, alignItems: 'center', backgroundColor:'white'}}>
            ...
            <View style={{paddingTop: hp(5)}}>
                <Button
                title="Autres"
                buttonStyle={{backgroundColor: "#ff8360", width: wp(22), height: wp(22), flexDirection: 'column'}}
                icon={
            ...
            <View style={{backgroundColor: 'white', borderRadius: 50, width: wp(85)}}>
                ...
                onValueChange={(itemValue, itemIndex) =>
                    ...
                    <Picker.Item label="Nuisance sonore" value="Nuisance sonore" />
                    <Picker.Item label="Tresorerie" value="Tresorerie" />
                    <Picker.Item label="Installation non autorisée" value="Installation non autorisée" />
                    <Picker.Item label="Objets encombrants" value="Objets encombrants" />
                    <Picker.Item label="Malfaçon" value="Malfaçon" />
                    <Picker.Item label="Litige" value="Litige" />
                    <Picker.Item label="Non-respect du règlement" value="Non-respect du règlement"/>
...
export default connect(mapStateToProps, null)(AutreProbleme);