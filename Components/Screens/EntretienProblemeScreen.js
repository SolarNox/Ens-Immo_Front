...
class EntretienProbleme extends React.Component {
    constructor() {
        super();
        this.state = {
            choicePicker: "Ascenseur",
            autreProbleme: "",
            descriptionProblem: "",
            privateOrNot: true
        }
    ...
    sendLogs = () => {
        ...
        fetch(`${ipAdress}/users/coproSendLog`, {
            ...
            body: `tokenUser=${this.props.user.token}&tokenCopro=${this.props.copro._id}&type=Entretien&titleType=${this.state.choicePicker}&privateOrNot=${this.state.privateOrNot}&title=${this.state.autreProbleme}&description=${this.state.descriptionProblem}`
        })
    ...
    render() {
        ...
        <View style={{ flex: 1, alignItems: 'center', backgroundColor:'white'}}>
            ...
            <View style={{paddingTop: hp(5)}}>
                <Button
                title="Entretiens"
                buttonStyle={{backgroundColor: "#7dce82", width: wp(22), height: wp(22), flexDirection: 'column'}}
                icon={
            ...
            <View style={{backgroundColor: 'white', borderRadius: 50, width: wp(85)}}>
                ...
                onValueChange={(itemValue, itemIndex) =>
                    ...
                    <Picker.Item label="Porte du garage" value="Porte du garage" />
                    <Picker.Item label="Contrôle d'accès" value="Contrôle d'accès" />
                    <Picker.Item label="Dératisation" value="Dératisation" />
                    <Picker.Item label="Propreté" value="Propreté" />
                    <Picker.Item label="VMC" value="VMC" />
                    <Picker.Item label="Plomberie" value="Plomberie" />
                    <Picker.Item label="Vitrerie" value="Vitrerie" />
...
export default connect(mapStateToProps, null)(EntretienProbleme);